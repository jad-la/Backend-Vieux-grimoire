...
router.post('/', auth, multer.upload, multer.resizeImage, controllerBook.createBook);
router.put('/:id', auth, multer.upload, multer.resizeImage, controllerBook.modifBook);
